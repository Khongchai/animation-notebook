...
// What makes WebGLL appears complicated to learn is simply this setup that
// kind of does the same thing everytime.
...
function createShaderFromScript(gl, scriptId, opt_shaderType) {
  ...
  // the script tag.
  if (!opt_shaderType) {
    if (shaderScript.type.contains("vertex")) {
      opt_shaderType = gl.VERTEX_SHADER;
    } else if (shaderScript.type.contains("fragment")) {
